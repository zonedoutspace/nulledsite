...
if (isset($_GET['order_id']) AND $_GET['order_id'] > 0) {
    ...
    $orderArray = array();
    $orderDetailsSql = "SELECT CASE order_payment_type WHEN 'Card' THEN' Online Payment'"
            . " ELSE CASE order_payment_type WHEN 'COD' THEN 'Cash On Delivery' "
            . " ELSE 'Pick From Office' END END AS payment_method,"
            . " order_number,order_user_id,users.user_first_name,order_status,order_shipment_charge,order_discount_amount,"
            . " order_total_amount,order_billing_first_name,order_billing_last_name,"
            . " order_billing_phone,order_billing_address,order_billing_country,order_billing_city,order_billing_zip,"
            . " order_shipping_first_name,order_shipping_last_name,order_shipping_phone,"
            . " order_shipping_address,order_shipping_country,"
            . " order_shipping_city,order_shipping_zip,order_promotion_codes,order_promotion_discount_amount FROM orders "
                    ...
                    <td valign="top" align="center">
                        <table cellspacing="0" cellpadding="10" width="600" border="0" bgcolor="#FFFFFF" style="border:1px solid #689F38;">
                            <tbody>
                                ...
                                <tr>
                                    <td valign="top">
                                        ...
                                        <p style="font-size:15px;line-height:16px;">
                                            Thank you for your order. Your order has been received through our system and waiting for approval. The details of your order are given below.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%" border="0" style="border:1px solid #689F38;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="ecxshipping">
                                                    ...
                                                    <td align="right"><?php echo number_format($orderTotalAmount, 2); ?></td>
                                ...
                                <tr><td bgcolor="#FFFFFF" align="center" class="ecxlast"><center><p style="font-size:15px;">&copy; <?php echo date("Y"); ?> ticketchai.com Ltd. All Rights Reserved</p></center></td></tr>
            </tbody>
        </table>
    </td>
</tr>
