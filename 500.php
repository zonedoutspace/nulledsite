                ...
                <div class="dtable-cell hw100">
                    <div class="container">
                        <div class="404-content text-center">
                            <h2 style="text-transform: uppercase; font-weight: bold;">Sorry!! It's not you. It's us.</h2>
                            <h5 style="text-transform: uppercase; margin: 15px 0;">
                                We are experiencing some internal server problem. 
                            </h5>
                            <h1 class="title-404">5<i class="fa fa-cog"></i><i class="fa fa-cog"></i></h1>
