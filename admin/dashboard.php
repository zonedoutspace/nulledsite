                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="panel-3d animated" style="visibility: visible;">
                            ...
                            <div class="back">
                                ...
                                <div id="ascrail2000" class="nicescroll-rails" style="width: 7px; z-index: 800; cursor: default; position: absolute; top: 41px; left: 237px; height: 165px; opacity: 0;"><div style="position: relative; top: 0px; float: right; width: 5px; height: 102px; border: 1px solid rgb(255, 255, 255); border-radius: 5px; background-color: rgb(66, 66, 66); background-clip: padding-box;"></div></div><div id="ascrail2000-hr" class="nicescroll-rails" style="height: 7px; z-index: 800; top: 199px; left: 1px; position: absolute; cursor: default; display: none; width: 236px; opacity: 0;"><div style="position: relative; top: 0px; height: 5px; width: 243px; border: 1px solid rgb(255, 255, 255); border-radius: 5px; background-color: rgb(66, 66, 66); background-clip: padding-box;"></div></div></div>
                        </div>
                    </div>
