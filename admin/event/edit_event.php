...
<html>
    ...
    <body class="">
        <?php
        $arr_event_category_id = explode(',', $event_category_id);
        $arr_event_category_id = json_encode($arr_event_category_id);
        ?>
        <?php include basePath('admin/header.php'); ?>
        <script id="treeview-template" type="text/kendo-ui-template">
            # var eve_catID = <?php echo $arr_event_category_id; ?> #
            <input type='checkbox' id='cat_#= item.category_id #' # if(item.category_id in eve_catID){# checked='checked' # } # name='event_category_id[]' 
