                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <?php if (!empty($arrayEventTickets[$Venues->venue_id])): ?>
                                                                                    <?php if (count($arrayEventTickets[$Venues->venue_id]) > 0): ?>
                                                                                        ...
                                                                                        <table class="table table-unstyled table-ticket" style="border: #0daf65 solid 1px;">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    <th colspan="4" style="width: 55%;" class="text-center"><h3>Event Tickets</h3></th>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <th style="width: 45%;" class="text-center">Ticket Type</th>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <br/>
                                                                                                            <p class="small text-center" ><?php echo html_entity_decode($Tickets->TT_type_description); ?></p>
                                                                                                        </td>
                                                                                                        <td>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <div class="ticket-info-footer" style="border-top: none !important;">
                                                                                ...
                                                                                <?php if (!empty($arrEventIncludes[$Venues->venue_id])): ?>
                                                                                    <?php if (count($arrEventIncludes[$Venues->venue_id]) > 0): ?>
                                                                                        <table class="table table-unstyled table-ticket" style="border: #005fcc solid 1px;">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    <th colspan="4" style="width: 55%;" class="text-center"><h3>Event Includes</h3></th>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <th style="width: 55%;" class="text-center">Includes Type</th>
                                                                                                <th style="width: 15%;" class="text-center">Quantity</th>
                                                                                            ...
                                                                                            <?php foreach ($arrEventIncludes[$Venues->venue_id] AS $Include): ?>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <h5 class="price text-center"><?php echo $Include->EI_name; ?></h5>
                                                                                                        ...
                                                                                                        <td><h4 class="price text-center"><?php echo $config['CURRENCY_SIGN']; ?> <?php echo $Include->EI_price; ?></h4></td>
                                                                                                        <td>
                                                                                                            <div class="ticket-info-footer" style="border-top: none !important;">
                                                                                                                <div class="price-box text-right">
